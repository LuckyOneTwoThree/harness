...
echo ""
echo "接下来你需要："
echo "  1. 编辑 AGENTS.md — 补充项目描述和关键约束"
echo "  2. 编辑 .env.example — 根据项目实际环境修改"
echo "  3. 编辑 CLAUDE.md — 如果使用 Claude Code"
echo "  4. 复制 .harness/gates/github-actions.yml 到 .github/workflows/ — 启用 CI 门控"
echo "  5. 配置飞书 Webhook — 见 .harness/skills/feishu-notify.md"
echo ""
echo "结构总览："
